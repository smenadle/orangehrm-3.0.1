...
class EmployeeDirectDepositForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->setValidators(array(
            ...
            'routing_num' => new sfValidatorNumber(array('required' => false, 'trim'=>true, 'max' => 2147483647)),
            'amount' => new sfValidatorNumber(array('required' => false, 'min' => 0, 'max'=> 999999999.99)),
        ));
