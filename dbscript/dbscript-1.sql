...
create table `hs_hr_employee` (
  ...
  `emp_permanent_address` VARCHAR(250) default null,
  `emp_personal_email` VARCHAR(50) default null,
  `emp_skype_id` VARCHAR(50) default null,
  `emp_phone_accesscode` VARCHAR(50) default null,
  `emp_father_name` VARCHAR(100) default null,
  `emp_husband_name` VARCHAR(100) default null,
  `emp_bldgp` VARCHAR(20) default null,
  `total_experience` DECIMAL(11,2),
  `current_experience` DECIMAL(11,2),
...
create table `ohrm_job_vacancy`(
    ...
    `hiring_manager1_id` int(13) default null,
	`name` varchar(100) not null,
	`description` text default null,
